defmodule Exmud.Prototype.PrototypeCategory do
  use Ecto.Schema
  import Ecto.Changeset
  import Ecto.Query, warn: false

  schema "prototype_categories" do
    field :name, :string
  ...
  @doc false
  def changeset(prototype_category, attrs) do
    prototype_category
    |> cast(attrs, [:name])
    |> validate_required([:name])
  end

  @spec new :: Exmud.Prototype.PrototypeCategory.t()
  def new do
    %__MODULE__{}
  end
end
